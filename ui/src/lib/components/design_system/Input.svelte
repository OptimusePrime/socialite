...
<div class="{className}">
    ...
    <div class="flex justify-end">
        ...
        <input class="p-4 font-sans font-bold text-primary-lighter placeholder-opacity-5 rounded-lg flex align-middle {sizes.get(size)} bg-primary-light border-none" placeholder={placeholder} bind:value={value} />
    </div>
